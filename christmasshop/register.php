      ...
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="">
            ...
            <div class="form-group ">
              <button type="button" class="btn btn-lg btn-default" id="generisiLozinku" style="background-color: #493dd3;">Generisi lozinku</button>
            </div>
            
            
            <div class="form-group ">
              <button type="submit" name="registracija" id="button" class="btn btn-primary btn-lg btn-block" style="margin-top: 3%; background-color: #493dd3; opacity: 0.8;">Registruj se na Christmas Shop</button>
            </div>
